...
class Complex(Primitive):
    def __init__(self, from_number: typing.Optional[complex] = None, real: typing.Optional[RealNumber] = None,
                 imag: typing.Optional[RealNumber] = None):
        super().__init__()
...
class OutputStream(IOStream):
    ...
    def __repr__(self):
        return "output stream " + super().__repr__()
...
class InputStream(IOStream):
    ...
    def __repr__(self):
        return "input stream " + super().__repr__()
...
def convert_nihonium(python_object: typing.Any):
    ...
    print(
        f"Warning, raw python object \"{python_object}\" of type \"{type(python_object)}\" is being passed to Nihonium runtime")
